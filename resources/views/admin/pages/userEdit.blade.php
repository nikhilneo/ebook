        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
                ...
                <h4 class="lead"> Edit <strong>{{ $user->name}}'s  </strong> Details here: </h4>
                <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.user.update',$user->id) }}">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' text-danger' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputName" placeholder="Name" name="name" value="{{ (old('name') != "" || old('name') != null) ? old('name') : $user->name }}">
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group{{ $errors->has('email') ? ' text-danger' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control" id="inputEmail" placeholder="Email" name="email" value="{{ (old('email') != "" || old('email') != null) ? old('email') : $user->email }}">
                            @if ($errors->has('email'))
                                <span class="text-danger">
