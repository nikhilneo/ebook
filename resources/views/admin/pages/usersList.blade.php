                        ...
                        @foreach ($users as $user)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('admin.user.show',$user->id)}}" class="btn btn-default btn-sm"><i class="fa fa-eye text-info"></i></a>
                                    <a href="{{route('admin.user.edit', $user->id)}}" class="btn btn-default btn-sm"><i class="fa fa-edit text-success"></i></a>
                ...
                @if (count($users) == 0)
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <a href="{{--url('user/register')--}}" class="btn btn-primary btn-block">Add New User</a>
                        </div>
                    </div>
                @endif
            </div>
